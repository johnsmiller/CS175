...
public class TabActivity extends Activity implements ActionBar.TabListener {
    ...
    public static final String PREFS_NAME ="FingerNinjaPreferences";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NetworkManager.setUser(settings.getString(USER_NAME, "User Name"));
        NetworkManager.setIP(settings.getString(IP_ADDRESS, "127.0.0.1"));
    ...
    public void onStop(){
        ...
        editor.putString(USER_NAME, NetworkManager.getUser());
        editor.putString(IP_ADDRESS, NetworkManager.getIP_ADDRESS());
    ...
    public static class SetUserMode extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            userNameView.setText(NetworkManager.getUser());
